...
public class OrderDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Gson gson = new Gson();
        Orderid orderid = gson.fromJson(new InputStreamReader(request.getInputStream()), Orderid.class);

        try {
            Database db = Database.getInstance();
            ArrayList<OrderInformation> informations = db.getOrderInformation(orderid.getOrderid());
            String jsonAnswer = gson.toJson(informations);
